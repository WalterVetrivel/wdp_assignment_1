...
(function () {
	...
	// To add markers
	var showMarkers = function showMarkers(worldMap, locationList) {
		locationList.forEach(function (location) {
			showInfoWindow(location, worldMap);
		});
	};

	// Initialise list of headquarters
	...
	window.addEventListener('load', function () {
		...
		showMarkers(worldMap, headquartersList);
	});
})();